...
mixin _$Note {
  ...
  int get hashCode => Object.hash(
      runtimeType, id, title, content, pinned, archived, createdAt, updatedAt);

  @override
  String toString() {
    return 'Note(id: $id, title: $title, content: $content, pinned: $pinned, archived: $archived, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
}
...
extension NotePatterns on Note {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, String title, String content, bool pinned,
            bool archived, DateTime createdAt, DateTime updatedAt)?
        $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _Note() when $default != null:
        return $default(_that.id, _that.title, _that.content, _that.pinned,
            _that.archived, _that.createdAt, _that.updatedAt);
      case _:
        return orElse();
    }
  }
